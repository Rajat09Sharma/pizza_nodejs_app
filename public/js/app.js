...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var userClickedPizza = JSON.parse(btn.dataset.pizza);
...
function _updateCart() {
  _updateCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userClickedPizza) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return axios.post("/update-cart", userClickedPizza);
        case 3:
          result = _context.sent;
          Toastify({
...
//admin socket 
var onAdminPage = window.location.pathname;
